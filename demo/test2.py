...
def myfun(x):
    if x == None:
        ...
        return ("Selected row key is " + ', '.join([str(i) for i in x]))
...
def myfun(x):
    if x == None:
        ...
        return ('Clicked cell is on row : {} col : {}'.format(x['row'], x['col']))
